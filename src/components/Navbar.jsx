    ...
    <nav className="fixed top-0 left-0 w-full bg-white/80 backdrop-blur-md border-b border-white/60 z-50">
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <div className="text-lg font-semibold text-[var(--primary)]">Ashutosh Pandey</div>
          <ul className="hidden md:flex items-center gap-6 text-sm font-medium text-slate-700">
            ...
            <li>
              <a href="/final.pdf" target="_blank" rel="noreferrer" className="btn btn-primary">
                View Resume
              </a>
            </li>
          </ul>
            ...
            <details className="relative">
              ...
              <div className="absolute right-0 mt-2 w-44 bg-white rounded-xl shadow-lg p-3">
                <ul className="flex flex-col gap-2 text-sm">
                  ...
                  <li>
                    <a href="/final.pdf" target="_blank" rel="noreferrer" className="block mt-2 btn btn-primary text-center">
                      View Resume
                    </a>
                  </li>
                </ul>
